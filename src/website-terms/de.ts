...
Diese Website wird von ${company} betrieben. Auf der gesamten Website beziehen sich die Begriffe "wir", "uns" und "unser" auf ${company}. ${company} bietet diese Website, einschließlich aller Informationen, Tools und Dienste, die von dieser Website aus zur Verfügung stehen, unter der Bedingung Ihrer Zustimmung zu allen hier genannten Bedingungen, Konditionen, Richtlinien und Mitteilungen.

Durch den Besuch unserer Website${when(conditions?.shop, ' und/oder den Kauf von etwas bei uns')} nutzen Sie unseren "Service" und stimmen zu, durch die folgenden Bedingungen und Konditionen ("Nutzungsbedingungen", "Bedingungen") gebunden zu sein, einschließlich der zusätzlichen Bedingungen und Konditionen und Richtlinien, auf die hier Bezug genommen wird und/oder die per Hyperlink verfügbar sind. Diese Nutzungsbedingungen gelten für alle Benutzer der Website, einschließlich, ohne Einschränkung, Benutzer, die Browser, Anbieter, Kunden, Händler und/oder Beitragende von Inhalten sind.

Bitte lesen Sie diese Nutzungsbedingungen sorgfältig durch, bevor Sie unsere Website aufrufen oder nutzen. Durch den Zugriff auf oder die Nutzung eines Teils der Website erklären Sie sich damit einverstanden, an diese Nutzungsbedingungen gebunden zu sein. Wenn Sie mit allen Bedingungen und Konditionen dieser Vereinbarung nicht einverstanden sind, dürfen Sie nicht auf die Website zugreifen oder irgendwelche Dienste nutzen. Wenn diese Nutzungsbedingungen als Angebot betrachtet werden, ist die Annahme ausdrücklich auf diese Nutzungsbedingungen beschränkt.

Alle neuen Funktionen oder Tools, die der aktuellen Website hinzugefügt werden, unterliegen ebenfalls den Nutzungsbedingungen. Sie können die aktuellste Version der Nutzungsbedingungen jederzeit auf dieser Seite einsehen. Wir behalten uns das Recht vor, jeden Teil dieser Nutzungsbedingungen durch Veröffentlichung von Aktualisierungen und/oder Änderungen auf unserer Website zu aktualisieren, zu ändern oder zu ersetzen. Es liegt in Ihrer Verantwortung, diese Seite regelmäßig auf Änderungen zu überprüfen. Ihre fortgesetzte Nutzung oder Ihr Zugriff auf die Website nach der Veröffentlichung von Änderungen stellt die Annahme dieser Änderungen dar.

## Servicebedingungen

Durch die Zustimmung zu diesen Nutzungsbedingungen erklären Sie, dass Sie mindestens das Alter der Volljährigkeit in Ihrem Bundesland oder Ihrer Provinz erreicht haben oder dass Sie das Alter der Volljährigkeit in Ihrem Bundesland oder Ihrer Provinz erreicht haben und uns Ihre Zustimmung gegeben haben, damit Minderjährige in Ihrem Haushalt diese Website nutzen können.
...
Ein Verstoß gegen eine der Bedingungen führt zu einer sofortigen, nicht erstattungsfähigen Kündigung Ihrer Dienste.
...
Wir können auch in Zukunft neue Dienste und/oder Funktionen über die Website anbieten (einschließlich der Veröffentlichung neuer Tools und Ressourcen). Solche neuen Funktionen und/oder Dienste unterliegen ebenfalls diesen Nutzungsbedingungen.
...
Diese Nutzungsbedingungen bleiben wirksam, sofern sie nicht von Ihnen oder von uns gekündigt werden. Sie können diese Nutzungsbedingungen jederzeit kündigen, indem Sie uns benachrichtigen, dass Sie unsere Dienste nicht mehr nutzen möchten, oder wenn Sie die Nutzung unserer Website einstellen.

Wenn Sie unserer alleinigen Einschätzung nach gegen eine Bestimmung oder Bedingung dieser Nutzungsbedingungen verstoßen oder wir vermuten, dass Sie gegen eine Bestimmung oder Bedingung dieser Nutzungsbedingungen verstoßen haben, können wir diese Vereinbarung jederzeit ohne Vorankündigung kündigen, und Sie haften weiterhin für alle bis zum Kündigungsdatum fälligen Beträge; und/oder wir können Ihnen den Zugang zu unseren Dienstleistungen (oder einem Teil davon) verweigern.

## Gesamte Vereinbarung

Das Unterlassen unsererseits, ein Recht oder eine Bestimmung dieser Nutzungsbedingungen auszuüben oder durchzusetzen, stellt keinen Verzicht auf dieses Recht oder diese Bestimmung dar.

Diese Nutzungsbedingungen und alle von uns auf dieser Website veröffentlichten Richtlinien oder Betriebsregeln oder in Bezug auf den Dienst stellen die gesamte Vereinbarung und das Verständnis zwischen Ihnen und uns dar und regeln Ihre Nutzung des Dienstes, wobei sie alle vorherigen oder gleichzeitigen Vereinbarungen, Mitteilungen und Vorschläge, ob mündlich oder schriftlich, zwischen Ihnen und uns außer Kraft setzen (einschließlich, aber nicht beschränkt auf frühere Versionen der Nutzungsbedingungen).

Unklarheiten bei der Auslegung dieser Nutzungsbedingungen dürfen nicht gegen die erstellende Partei ausgelegt werden.
${when(country, `
## Geltendes Recht
...
Wir behalten uns das Recht vor, nach unserem alleinigen Ermessen jeden Teil dieser Nutzungsbedingungen durch Veröffentlichung von Aktualisierungen und Änderungen auf unserer Website zu aktualisieren, zu ändern oder zu ersetzen. Es liegt in Ihrer Verantwortung, unsere Website regelmäßig auf Änderungen zu überprüfen. Ihre fortgesetzte Nutzung oder Ihr Zugriff auf unsere Website oder den Dienst nach der Veröffentlichung von Änderungen dieser Nutzungsbedingungen stellt die Annahme dieser Änderungen dar.

## Lizenz

Sofern nicht anders angegeben, besitzen ${company} und/oder seine Lizenzgeber die geistigen Eigentumsrechte an allen Materialien auf der Website. Alle geistigen Eigentumsrechte sind vorbehalten. Sie dürfen auf diese Website für Ihren persönlichen Gebrauch zugreifen, der in diesen Nutzungsbedingungen festgelegten Einschränkungen unterliegt.

Sie dürfen nicht:
 - Material von ${website} und anderen Diensten von ${company} erneut veröffentlichen
 - Material von ${website} und anderen Diensten von ${company} verkaufen, vermieten oder unterlizenzieren
 - Material von ${website} und anderen Diensten von ${company} vervielfältigen, duplizieren oder kopieren
 - Inhalte von ${website} und anderen Diensten von ${company} umverteilen
...
Die Verwendung des Logos oder anderer Grafiken von ${company} für Verlinkungen ist ohne Markenlizenzvereinbarung nicht gestattet.

## Kontaktinformationen

Fragen zu den Nutzungsbedingungen sollten an uns gesendet werden an [${email}](mailto:${email}).
`.trim();
