...
This Privacy Policy describes how your Personal Information is collected, used, and shared when you use${when(conditions?.shop, ' or make a purchase from')} ${appName} (the “App”).

## Personal information we collect

When you use the App, we automatically collect certain information about your device, including information about your operating system, IP address, time zone, and some of the tracking software that is installed on your device. Additionally, as you use the App, we collect information about the individual views that you open, what websites or search terms referred you to the App, and information about how you interact with the App. We refer to this automatically-collected information as “Device Information.”

### We collect Device Information${when(!conditions?.shop, ' (or Personal Information)')} using the following technologies:

 - “Log files” track actions occurring on the App, and collect data including your IP address, device type, Internet service provider, referring/exit views, and date/time stamps.
${when(conditions?.tracking, `
 ...
 - “beacons,” “tags,” and “pixels” are electronic files used to record information about how you use the App.
`.trim())}

${`
${when(conditions?.shop, 'Additionally when you make a purchase or attempt to make a purchase through the App, we collect certain information from you, including your name, billing address, shipping address, email address, and phone number. We refer to this information as “Order Information.”')}
...
`)}
We use the Device Information that we collect to help us screen for potential risk and fraud (in particular, your IP address), and more generally to improve and optimize our App (for example, by generating analytics about how our users browse and interact with the App, and to assess the success of our marketing and advertising campaigns).
## Sharing your Personal Information

We share your Personal Information with third parties to help us use your Personal Information, as described above. For example, we use a hosting provider to power our servers used by the App.
...
`)}
## Do not track
Please note that we do not alter our App’s data collection and use practices when we see a Do Not Track signal from your operating system.
...
${when(minimumAge, `
## Age restrictions
The App is not intended for individuals under the age of ${minimumAge}.
`)}
## Changes
