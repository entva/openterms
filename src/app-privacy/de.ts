...
Wenn Sie die App besuchen, sammeln wir automatisch bestimmte Informationen über Ihr Gerät, einschließlich Informationen über Ihren Webbrowser, Ihre IP-Adresse, Ihre Zeitzone und einige der Cookies, die auf Ihrem Gerät installiert sind. Darüber hinaus sammeln wir während Sie auf der App surfen Informationen über die einzelnen Webseiten, die Sie anzeigen, welche Websites oder Suchbegriffe Sie auf die Website verwiesen haben, und Informationen darüber, wie Sie mit der Website interagieren. Wir bezeichnen diese automatisch gesammelten Informationen als „Geräteinformationen“.

### Wir sammeln Geräteinformationen${when(!conditions?.shop, ' (oder persönliche Informationen)')} mit den folgenden Technologien:

 - „Logdateien“ verfolgen Aktionen, die auf der App stattfinden, und sammeln Daten einschließlich Ihrer IP-Adresse, Browsertyp, Internetdienstanbieter, Verweis-/Ausstiegsseiten und Datums-/Zeitstempel.
${when(conditions?.tracking, `
 ...
 - „Web-Beacons“, „Tags“ und „Pixel“ sind elektronische Dateien, die verwendet werden, um Informationen darüber aufzuzeichnen, wie Sie auf der App surfen.
`.trim())}
...
Wir verwenden die Bestellinformationen, die wir im Allgemeinen sammeln, um Bestellungen, die über die App getätigt werden, zu erfüllen (einschließlich der Verarbeitung Ihrer Zahlungsinformationen, der Organisation, der Bereitstellung von Rechnungen und/oder Auftragsbestätigungen). Darüber hinaus verwenden wir diese Bestellinformationen, um:
...
`)}
Wir verwenden die gesammelten Geräteinformationen, um uns bei der Überprüfung auf potenzielle Risiken und Betrug zu helfen (insbesondere Ihre IP-Adresse) und allgemeiner, um unsere App zu verbessern und zu optimieren (zum Beispiel durch Erstellen von Analysen darüber, wie unsere Benutzer auf der App surfen und mit ihr interagieren, und um den Erfolg unserer Marketing- und Werbekampagnen zu bewerten).

## Weitergabe Ihrer persönlichen Daten

Wir geben Ihre persönlichen Daten an Dritte weiter, um uns bei der Nutzung Ihrer persönlichen Daten zu helfen, wie oben beschrieben. Zum Beispiel verwenden wir einen Hosting-Anbieter, um unsere App zu betreiben.
...
`)}
## Nicht verfolgen
Bitte beachten Sie, dass wir die Datenerfassungs- und Nutzungspraktiken unserer App nicht ändern, wenn wir ein Do Not Track-Signal von Ihrem Browser sehen.
