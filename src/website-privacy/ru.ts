...
Эта Политика конфиденциальности описывает, как ваша личная информация собирается, используется и передается, когда вы посещаете${when(conditions?.shop, ' или совершаете покупку на')} [${website}](${website}) (далее "Сайт").

## Личная информация, которую мы собираем

Когда вы посещаете Сайт, мы автоматически собираем определенную информацию о вашем устройстве, включая информацию о вашем веб-браузере, IP-адресе, часовой зоне и некоторые из установленных на вашем устройстве файлов cookie. Кроме того, когда вы просматриваете Сайт, мы собираем информацию о отдельных веб-страницах, которые вы просматриваете, о том, с каких веб-сайтов или поисковых запросов вы перешли на Сайт, а также информацию о том, как вы взаимодействуете с Сайтом. Мы называем эту автоматически собираемую информацию "Информация об устройстве".
...
${`
${when(conditions?.shop, 'Кроме того, когда вы совершаете покупку или пытаетесь совершить покупку на Сайте, мы собираем определенную информацию о вас, включая ваше имя, адрес для выставления счета, адрес доставки, адрес электронной почты и номер телефона. Мы называем эту информацию "Информация о заказе".')}
...
Мы используем Информацию о заказе, которую мы собираем, в основном для выполнения любых заказов, размещенных через Сайт (включая обработку вашей платежной информации, организацию доставки и предоставление вам счетов и/или подтверждений заказов). Кроме того, мы используем эту Информацию о заказе для:
 - Общения с вами;
 - Проверки заказов на наличие потенциального риска или мошенничества; и
 - В соответствии с вашими предпочтениями, предоставления вам информации или рекламы, касающейся наших продуктов или услуг.
`)}
Мы используем Информацию об устройстве, которую мы собираем, чтобы помогать нам выявлять потенциальные риски и мошенничество (в частности, ваш IP-адрес), а также в более общем плане для улучшения и оптимизации нашего Сайта (например, путем генерации аналитических данных о том, как наши пользователи просматривают и взаимодействуют с Сайтом, и для оценки успеха наших маркетинговых и рекламных кампаний).

## Передача вашей личной информации

Мы делимся вашей Личной информацией с третьими сторонами, чтобы помочь нам использовать вашу Личную информацию, как описано выше. Например, мы используем хостинг-провайдера для обеспечения работы нашего веб-сайта.
